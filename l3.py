l33=[
...

  {
    ...
    "options": [
      {"text": "Challenge Stalin to a dance-off.", "next_id": 14},
      {"text": "Offer the Russians gelato.", "next_id": 15},
      {"text": "Accidentally become a folk hero.", "next_id": 16}
    ]
  },
  {
    "id": 13,
  ...
  {
    "id": 16,
    "title": "Comrade Cannoli",
    "text": "During the cannoli food fight, one of your cannolis accidentally hits a famous Soviet propaganda poster.  The cannoli sticks to the poster in a way that makes it look like you're heroically offering the Soviet people a delicious treat.  You become a national hero in Russia.  Stalin, fearing your popularity, declares you the winner of WWII and retires to a dacha filled with cannolis.",
    "options": []
  },
  {
    "id": 17,
    "title": "The Über L3/33 Goes Hollywood",
    "text": "While conquering France, a film crew mistakes the Über L3/33 for a new, revolutionary special effects robot. You become a movie star! The film, 'Über Tank: The Cannoli Crusader,' becomes a massive hit.  World leaders, impressed by your acting skills, decide to hand you the victory. You win WWII by becoming a cultural icon.",
    "options": [
      {"text": "Demand a bigger trailer.", "next_id": 18},
      {"text": "Use your fame to promote world peace (and cannolis).", "next_id": 19}
    ]
  },
    {
    "id": 18,
    "title": "Trailer Troubles",
    "text": "You demand a bigger trailer.  Your demands become so outrageous that they start a new war.  This one is against your own fan club.  You lose.",
    "options": []
  },
    {
    "id": 19,
    "title": "Peace Through Cannolis",
    "text": "You use your fame to promote world peace and, of course, cannolis. Your message of love, understanding, and delicious pastries resonates with people all over the world.  World peace is achieved.  And everyone is slightly fatter.",
    "options": []
  },
    {
    "id": 20,
    "title": "The Über L3/33's Got Talent",
    "text": "While stuck in reverse (thanks, gnome!), you accidentally enter a local talent show.  Your backwards driving, combined with the gnome's magic, makes it look like you're performing an incredibly complex and graceful ballet.  You win the talent show.  The judges are so impressed that they decide to just give you the entire world.  You win WWII by being surprisingly graceful while moving in reverse.",
    "options": []
  }
